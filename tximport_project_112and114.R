...
base_dir <- c(base_dir1, base_dir2)
...
names(files) <- c(file_name1, file_name2) ##naming the list with the sample names
...
txi.kallisto.tsv <- tximport(files, type = "kallisto", tx2gene = tx2gene[,c(1,3)])

##Save file and put it in s3cmd
saveRDS(txi.kallisto.tsv, 'Garry_Project_112and114_pig_bulkRNA_31samples_genename.rds')
